...
# Form implementation generated from reading ui file 'mission2.ui'
#
...
"background-color:qlineargradient(spread:pad, x1:0.492174, y1:0.018, x2:0.502, y2:1, stop:0.432836 rgba(255, 53, 56, 255), stop:1 rgba(255, 255, 255, 255));}")
        ...
        self.image_label.setGeometry(QtCore.QRect(0, 0, 1000, 500))
        self.image_label.setObjectName("image_label")
        self.answer_button = QtWidgets.QPushButton(self.widget)
        self.answer_button.setGeometry(QtCore.QRect(390, 300, 201, 111))
        font = QtGui.QFont()
...
"font: 75 8pt \"MS Serif\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.answer_button.setText(_translate("Dialog", "SHAPES"))
