...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(50, 130, 211, 121))
        ...
        self.actionEdit.triggered.connect(lambda: self.clicked("New was clicked"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionEdit.setStatusTip(_translate("MainWindow", "Create a new file"))
        self.actionEdit.setShortcut(_translate("MainWindow", "Ctrl+N"))
